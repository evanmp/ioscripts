...
#    '''Up to now, we have only exported data  THIS WILL DELETE USERS!  COMMENT OUT DURING TESTING'''
#    print "All bad users dumped! Commencing to get rid of all %s users" % total
